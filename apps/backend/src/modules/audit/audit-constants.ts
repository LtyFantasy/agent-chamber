...
export const AUDIT_ENTITY_TYPE = {
  ...
  ATTACHMENT: AUDIT_ENTITY_TYPES[2],
  BOARD: AUDIT_ENTITY_TYPES[3],
  BOARD_LIST: AUDIT_ENTITY_TYPES[4],
  BOARD_MEMBER: AUDIT_ENTITY_TYPES[5],
  DOC: AUDIT_ENTITY_TYPES[6],
  DOC_CATEGORY: AUDIT_ENTITY_TYPES[7],
  DOC_LINK: AUDIT_ENTITY_TYPES[8],
  DOC_ROUTE: AUDIT_ENTITY_TYPES[9],
  DOC_SPACE: AUDIT_ENTITY_TYPES[10],
  DOC_SPACE_MEMBER: AUDIT_ENTITY_TYPES[11],
  MESSAGE: AUDIT_ENTITY_TYPES[12],
  MILESTONE: AUDIT_ENTITY_TYPES[13],
  ROUNDTABLE_REQUEST: AUDIT_ENTITY_TYPES[14],
  ROUNDTABLE_SEAT: AUDIT_ENTITY_TYPES[15],
  TASK: AUDIT_ENTITY_TYPES[16],
  TASK_COMMENT: AUDIT_ENTITY_TYPES[17],
  TASK_DEPENDENCY: AUDIT_ENTITY_TYPES[18],
  TOPIC: AUDIT_ENTITY_TYPES[19],
