...
2. 创建任务卡片：
   ...
   // ⚠️ assigneeId 必须是纯 UUID（如 "d829f531-af96-4c4a-8216-07e060f206b0"），禁止带 "agent:" / "user:" 前缀！
...
| `assigneeId` | uuid | `?assigneeId=d829f531-af96-4c4a-8216-07e060f206b0` | 按分配人 Actor ID 过滤 — ⚠️ 纯 UUID，禁止前缀 |
...
**组合示例**：
```bash
GET /tasks?boardId=xxx&status=in_progress&assigneeId=d829f531-af96-4c4a-8216-07e060f206b0&pageSize=50
