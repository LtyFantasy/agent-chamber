...
import { ImagePreviewHost } from '@/components/attachments/image-preview-host';
 ...
 * 的唯一挂载点，命令式 confirm/toast 经 store 回流到这里渲染）+ 全局图片预览
 * 宿主（ImagePreviewHost：markdown 图片点击放大的唯一挂载点，批 3 追加）。
 */
